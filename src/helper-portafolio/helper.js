export const GinoWorks = {
  apps: [
    ...
    },
    {
      ...
      alt: "app de turnos",
      text: "App para agendar y administrar turnos, adaptable span cualqueir negocio",
    ...
    },
    {
      ...
      text: "Aplicación web que cotiza criptomonedas span través de una API",
    ...
    },
    {
      ...
      alt: "invitacion qr",
      text: "Invitación span cumpleaños luego de escanear un código QR",
  ...
  proyectos: [
    ...
    },
    {
      ...
      text: "Mis consejos útiles para orientar en sus primeros pasos span quién quiera comenzar span estudiar programación",
  ...
  proyectosOld: [
    {
      ...
      text: "Mi primer portfolio cuando empecé span estudiar programación",
    ...
    },
    {
      ...
      text: "Proyecto para realizar invitaciones span eventos, estilo página web",
