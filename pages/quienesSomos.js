        ...
        <section className="text-lightGray">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-center space-y-8 md:space-y-4 p-8 md:p-16">
              ...
              <p>
                Dev Zeppelin es mi proyecto como estudiante de programación y tecnología, comprometido con proyectos reales que solucionen problemas span personas y emprendedores comunes.
              </p>
              <p>
                Creo firmemente que span través de la tecnología se pueden cambiar muchas cosas, por eso creé este proyecto para poder volcar mis esfuerzos y estudios en crear soluciones aplicando mis conocimientos en programación y tecnología.
              </p>
              <p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-16 px-8 md:px-32 pb-16 text-center text-lightGray">
          <div className="space-y-4">
            ...
            <p>
              ...
              últimas tecnologías span su favor. Transmitir valores como el
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              Avanzar para buscar los mejores acuerdos y ser el recurso accesible para dar forma tecnológica span las ideas de las personas comunes.
            </p>
          </div>
        </section>
      </Layout>
