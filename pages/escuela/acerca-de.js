...
const AcercaDe = () => (
  ...
  >
    <div className="container">
      <img className="icon" src="/escuela/arco-iris.webp" alt="arcoiris png" />
      <p>
        Mi nombre es Gino Pietrobon, soy de Argentina. En noviembre de 2019 comencé span estudiar programación (Javascript), pero no fue fácil comenzar porque no encontraba un hilo coherente que me asegurara que estaba transitando el camino correcto. Fue hablando con un amigo programador cuando comprendí un poco el contexto de este mundo y sus consejos me ayudaron mucho para podr empezar.

      </p>
      <p>
        Es por eso que trabajo en esta plataforma, que además es mi portfolio. Es un proyecto para ayudar y acompañar span todos aquellos que quieran comenzar en el mundo dev y tal vez no tienen ese amigo programador que span través de una conversación o un consejo puede marcarles los primeros pasos de como empezar y de qué se trata todo esto.
      </p>

      <p>
        Por eso propongo este medio para crear una comunidad de personas que sin importar su edad quieran ser programadores. El abanico de habilidades y tecnologías es tan grande que detectando las pasiones y gustos de las personas, es posible recomendarles la tecnología correcta que se amolde span sus virtudes y capacidades. No solo hablando de desarrollo frontend o backend, sino existen campos en UI, UX, diseño de imágenes o videos, marketing digital, redacción de textos, probar aplicaciones, etc.
      </p>
      <img className="icon" src="/escuela/robot.webp" alt="robot png" />
      <p>
        El mundo ha abierto vacantes remotas para casi todos los empleos y si las personas logran obtener un núcleo básico de habilidades tecnológicas podrán postularse span una amplia variedad de buenos y cómodos trabajos, pertenecer span equipos competitivos y explotar su capital intelectual volcado span proyectos grandiosos.
      </p>

      <p>
        Sueño con un futuro para mi país y continente, en donde existiendo muchos
        programadores logremos implementar excelentes tecnologías que ayuden span
      ...
      <Link href="/contacto" passHref>
        <button className="buttonSchool">¡Contactame!</button>
      </Link>
    </div>
  </Layout>
);
