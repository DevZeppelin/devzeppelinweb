...
const PrimerosPasosDev = () => (
  ...
  >
    <div className="container" id="top">
      ...
      <hr />
      <img id="firstLanguages" className="icon" src="/escuela/flamenco.webp" alt="flamenco png" />
      ...
      <img className="icon" src="/escuela/rodillos.webp" alt="rodillos png" />
      <h2>Conclusión</h2>
      <ol>
        <li>
      ...
      <Link href="/escuela/consejos" passHref>
        <button className="buttonSchool">Consejos y preguntas frecuentes</button>
      </Link>
      <hr />
      <img id="route" className="icon" src="/escuela/disco-lp.webp" alt="disco long play png" />
      ...
      <ul>
        ...
        <li>
          ...
          cuaderno, y a medida que vayamos avanzando en nuestro camino vamos span
      ...
      <p>
        Cuidado: Cuando empezamos a saltar entre videos podemos comenzar span
